...
import { AutoImporter } from '@/components/recipe-import/auto-importer';
import {
  Card,
  CardContent,
  CardDescription,
      ...
      <div className='max-w-4xl mx-auto space-y-6'>
        ...
        <div className='space-y-2'>
          ...
          <p className='text-muted-foreground'>
            Easily import recipes from your favorite cooking websites or add
          ...
          <TabsContent value='single' className='space-y-4'>
            <Card>
              ...
              <CardContent className='space-y-4'>
                <Suspense fallback={<Button disabled variant="outline" className="gap-2"><Import className="h-4 w-4" />Loading...</Button>}>
                  <RecipeImportDialog />
                </Suspense>
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    ...
                    <ol className='mt-2 ml-4 list-decimal text-sm space-y-1'>
                      <li>
                        Copy the URL of any recipe from a supported website
                      </li>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              We support recipe import from these popular cooking websites and
              many more
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground mt-4'>
              ...
              standard recipe markup (JSON-LD or Microdata). If a site isn't
              listed but has recipe pages, try importing anyway!
            </p>
          </CardContent>
        </Card>
