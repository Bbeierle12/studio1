...
const mealTypeColors: Record<MealType, string> = {
  BREAKFAST: 'border-meal-breakfast',
  LUNCH: 'border-meal-lunch',
  DINNER: 'border-meal-dinner',
      ...
      <div className="p-6 space-y-6 bg-background">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-lg font-semibold text-foreground">{weather.condition}</div>
                  </div>
                </div>
                ...
                {weather.windSpeed && (
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-semibold text-foreground">{weather.windSpeed} mph</div>
                    </div>
                  </div>
                )}
        ...
        <div className="space-y-4">
          {MEAL_TYPES.map(mealType => {
            ...
            return (
              <Card key={mealType} className={cn('border-l-4 bg-card border-border', mealTypeColors[mealType])}>
                <CardHeader>
                ...
                <CardContent>
                  {meals.length > 0 ? (
                    <div className="space-y-4">
                      {meals.map(meal => (
                        <div key={meal.id} className="border border-border rounded-lg p-4 bg-card hover:bg-accent transition-colors">
