...
export function RecipeEditForm({ recipe }: RecipeEditFormProps) {
  ...
  const canEdit = user && (!recipe.userId || user.id === recipe.userId);
  ...
  return (
    <form onSubmit={handleSubmit} className='space-y-6'>
      ...
      <input
        type='hidden'
        name='contributor'
        value={user?.name || recipe.contributor}
      />
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
        <div className='space-y-2'>
          ...
          {state.errors?.course && (
            <p className='text-sm text-destructive'>{state.errors.course}</p>
          )}
        </div>
        <div className='space-y-2'>
          ...
          {state.errors?.cuisine && (
            <p className='text-sm text-destructive'>{state.errors.cuisine}</p>
          )}
        </div>
        <div className='space-y-2'>
      ...
      <div className='space-y-2'>
        ...
        />
        {state.errors?.story && (
          <p className='text-sm text-destructive'>{state.errors.story}</p>
        )}
      </div>
